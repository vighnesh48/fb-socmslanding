  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden font-sans flex flex-col justify-center items-center mt-[80px]">
      <motion.div
        ...
        style={{ backgroundImage: "url('/herosection/bgimg.webp')" }}

      />

      <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/40 to-black/40" />
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-3 sm:px-6 md:px-8 grid lg:grid-cols-12 gap-6 sm:gap-10 items-center">
        ...
        >
          <div className="max-w-xl text-center lg:text-left mx-auto lg:mx-0 p-5 backdrop-blur-0 bg-white/5 rounded-md">
            ...
            <span className="text-2xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-red-600 to-red-400 bg-clip-text text-transparent tracking-wide drop-shadow-[0_4px_15px_rgba(0,0,0,0.7)] mb-1">
              Sandip University
            </span>
            ...
            <p className="text-xs sm:text-base md:text-3xl text-gray-200 mt-4 leading-relaxed drop-shadow-lg">
              Applications Invited for <span className="font-semibold text-white">SU-MAT 2026</span> <br />
              <span className="text-xs sm:text-base md:text-xl">Applicable for only PG course</span>
            </p>

            <div className="mt-5 flex items-center justify-center gap-6 sm:gap-10 bg-black/50 backdrop-blur-xl border border-white/10 px-4 sm:px-6 py-3 rounded-2xl shadow-xl text-white w-full max-w-xs sm:max-w-md mx-auto lg:mx-0">
              <div className="text-center">
                <p className="text-[10px] sm:text-[15px] text-gray-100">Last Date to Apply</p>
                <h3 className="text-sm sm:text-base font-bold"> 24th April 2026</h3>
              </div>

              <span className="text-gray-400 text-base sm:text-lg font-light">|</span>

              <div className="text-center">
                <p className="text-[10px] sm:text-[16px] text-gray-100">SU-MAT Exam</p>
                <h3 className="text-sm sm:text-base font-bold">26th April 2026</h3>
              </div>
            </div>
              <button
